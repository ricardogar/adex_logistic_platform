    ...
    describe('Truck Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/trucks';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a Truck', () => {
                service.create(new Truck(null)).subscribe(received => {
            ...
            it('should update a Truck', () => {
                service.update(new Truck(123)).subscribe(received => {
