...
import { CompanyMainComponent } from 'app/entities/company-main/company-main.component';
...
describe('Component Tests', () => {
    describe('CompanyMain Management Component', () => {
        let comp: CompanyMainComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(CompanyMainComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.companyMains[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
