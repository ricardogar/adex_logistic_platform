    ...
    describe('Transport Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/transports';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a Transport', () => {
                service.create(new Transport(null)).subscribe(received => {
            ...
            it('should update a Transport', () => {
                service.update(new Transport(123)).subscribe(received => {
