    ...
    describe('Fuel Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/fuels';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a Fuel', () => {
                service.create(new Fuel(null)).subscribe(received => {
            ...
            it('should update a Fuel', () => {
                service.update(new Fuel(123)).subscribe(received => {
