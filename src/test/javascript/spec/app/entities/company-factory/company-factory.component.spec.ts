...
import { CompanyFactoryComponent } from 'app/entities/company-factory/company-factory.component';
...
describe('Component Tests', () => {
    describe('CompanyFactory Management Component', () => {
        let comp: CompanyFactoryComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(CompanyFactoryComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.companyFactories[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
