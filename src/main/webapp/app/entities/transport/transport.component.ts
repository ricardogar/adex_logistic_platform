...
export class TransportComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        if (this.currentSearch) {
            this.transportService
                ...
                .subscribe(
                    (res: HttpResponse<ITransport[]>) => this.paginateTransports(res.body, res.headers),
    ...
    registerChangeInTransports() {
        this.eventSubscriber = this.eventManager.subscribe('transportListModification', response => this.reset());
    }
    ...
    private paginateTransports(data: ITransport[], headers: HttpHeaders) {
